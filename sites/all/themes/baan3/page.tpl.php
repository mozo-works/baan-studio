...
<!--           <a href="<?php print check_url($front_page); ?>" title="<?php print check_plain($site_name); ?>"><img src="/sites/baanstudio.com/themes/baan2/images/baan.png" style="width: 72px;" /></a> -->
          <?php endif; ?>
        </div> <!-- /#sitename -->
        <div id="project-nav">
        <?php
